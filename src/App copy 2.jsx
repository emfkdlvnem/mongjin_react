  ...
  return (
    ...
    <div className="bg-primary-content">
      <Routes>
        {/* page */}
        <Route path="/" />
        <Route path="/SLP소개" element={<div>SLP소개</div>} />
      </Routes>
      {/* header */}
      <nav className="flex h-12 items-center  px-5">
        ...
        <button className="btn btn-ghost rounded-full bg-amber-200 p-2 cursor-pointer mr-10">
          <span className="text-black">SLP</span>
        </button>
        ...
        <div className="flex items-center">
          <button className="btn btn-ghost rounded-full bg-amber-200 p-2 cursor-pointer ml-10">
      ...
      <div className="relative flex justify-center">
        ...
        <div className="absolute right-10 top-1/2">
          <p className="text-right font-extrabold text-2xl">
            SLP 초등부 <br />
            신입생 모집
          </p>
        </div>
